...
* Download the following <a href="static/PS/PS12_lastname_firstname.Rmd" download>Rmd template</a> file and rename the file appropriately.
...
* Watch the above 3m38s video (also in ModernDive 8.5) on bunny rabbits, dragons, and the Central Limit Theorem.
* At the end of lecture on Wednesday 12/12 you will be given a 5 minute quiz. This quiz is not meant to be difficult; it is meant simply to ensure that you watch the video.
