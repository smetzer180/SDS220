...
library(ggplot2)
library(dplyr)
# Hint: https://twitter.com/rudeboybert/status/963504925744488450
library(janitor)
library(moderndive)



# 2. Include all code necessary to View() the data in RStudio ----
# For example the code loading a CSV file or Excel spreadsheet.
View(house_prices)



# 3. Select only the variables you'll be using in the following order ----
...
# 4. Write down what scientific research question ----
...
# 5. Create "exploratory data analysis" visualizations of your data ----

# 5.a) Histogram of outcome variable
...
# 5.b) Exploratory data visualizations involving each of your y, x1, and x2
...
# 6. Citations. Include all relevant links/reference here for now that will
