...
<!--
* Problem sets:
    + Giving personalized feedback to 40 students over approximately 13 problem sets is difficult given that I only have one grader. **It is your responsibility to do a "self-evaluation" after solutions are posted.**
    ...
    + PS04 (imperfect) grading rubric [posted](PS.html#PS04_R_solutions).
    + Going forward (imperfect) grading rubric will be posted at the same time as problem set.
-->
...
* Posted rubrics for each problem set.
* XXX on Friday 10/19 (next week) as I will be away at the [2018 Women in Statistics and Data Science Conference](https://ww2.amstat.org/meetings/wsds/2018/){target="_blank"} along with Prof. Miles Ott and five Smith students who will be presenting. 
* Remember that the project proposal is due on Friday 10/19 at 5pm,  I leave for the conference on Wednesday at 3pm and won't be able to answer your questions, so plan accordingly. 
* Reminder tonight is: 
