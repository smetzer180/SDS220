...
* Upcoming schedule:
    ...
    + Tue 11/13: No lab given that PS09 involves no R. However Jenny will still be in SR301 to answer questions.
    + Wed 11/14: Quiz at end of lecture posted under PS09; no R Markdown component. 
    + **New**: Mon 11/19: Lecture starts at 1:20pm to accommodate for the SDS talk below from 12:10-1:10 pm Ford Hall 240! 
    + Tue 11/20: No lab.
* **Are you?**
...
* "Tactile sampling simulation" (by hand) and "Virtual sampling simulation" (using computer)
...
* 8.2
* 8.3 from start to end of 8.3.3
