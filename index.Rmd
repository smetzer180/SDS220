...
* **Readings + Extra**: MD is ModernDive, OI is [OpenIntro](https://www.openintro.org/download.php?file=isrs1_tablet&referrer=/stat/textbook.php){target="_blank"}.
* **DataCamp Course**: To be assigned in problem sets.
* **Important Date**: All deadlines posted in this column.
...
* **Please** complete the Intro Survey posted in [Lec 1](#Lec1TODO) if you haven't already.
...
* Office hours are now posted on [syllabus](syllabus.html)
