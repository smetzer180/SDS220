...
* Syllabus:
    ...
    + Added note about when to do [DataCamp](syllabus.html#datacamp) courses.

## Today's Activity

<!--
1. "Should I be copying/pasting/tweeking code directly in the console?" Creating `.R` script files AKA "scratchpads"
1. Chalk Talk: The Grammar of Graphics
1. Go over ModernDive Chapters 
-->
