...
* Upcoming schedule:
    + **Fri 11/2 - Sun 11/4**: Midterm II
    + **Wed 11/7**: PS08 due & class time to work on projects
    + **Fri 11/9**:
        1. Project initial submission due: ~~5pm~~ New due time: 9pm
        1. Extra office hours 5-6pm by appointment on Slack.
    + **Wed 11/14**: PS09 (posted early) is preparing for a quiz; no R Markdown component. 
