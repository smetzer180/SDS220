...
<!--
Explain what Whole Foods is.

<blockquote class="twitter-tweet" data-lang="en"><p lang="en" dir="ltr">A thread on <a href="https://twitter.com/WholeFoods?ref_src=twsrc%5Etfw">@WholeFoods</a> and elections: <a href="https://twitter.com/Redistrict?ref_src=twsrc%5Etfw">@Redistrict</a> recently wrote that Dems will perform the best in areas that are geographically close to Whole Foods (WF). I decided to map/calculate the # of Whole Foods by congressional district to test his theory on WF and elections (1/9) <a href="https://t.co/9fw6qTjOZZ">pic.twitter.com/9fw6qTjOZZ</a></p>&mdash; Grant Gregory (@GrantrGregory) <a href="https://twitter.com/GrantrGregory/status/1054044407912194049?ref_src=twsrc%5Etfw">October 21, 2018</a></blockquote>
...
* Updated upcoming schedule:
    + **New - Today**: Office hours from ~~3-6pm~~ 3-4:45pm.
    + Tue 11/6: Regular office hours from 3-6pm.
    + Wed 11/7: PS08 R Markdown due at 1pm & class time to work on projects.
    + **New - Thu 11/8**: No lab given that PS09 involves no R. However Jenny will still be in SR 301 to answer questions.
    + Fri 11/9:
        1. Project initial submission due at ~~5pm~~ 9pm
        1. Extra office hours 5-6pm by appointment; please Slack me.
    + **New - Tue 11/13**: No lab given that PS09 involves no R. However Jenny will still be in SR 301 to answer questions.
    + Wed 11/14: Quiz at end of lecture posted under PS09; no R Markdown component. 
    + **New - Tue 11/20**: No lab.
