...
* Click [here](https://rstudio.cloud/spaces/4441/join?access_code=KMu7j8TpEMdb1XCXB9Dbj%2B8%2F79dQaS1nchX2PCtO){target="_blank"} to join RStudio Cloud. Use any email address you like. 
...
* Lab section Tuesday/Thursday: Start Problem set 2 [below](#PS02)
...
* Complete the "Introduction to the Tidyverse" course, which you should see in the following [link](https://www.datacamp.com/enterprise/2018-09-sds220-intro-to-probability-statistics/assignments){target="_blank"}:
...
To be posted before Tuesday 9/18 at 9am
