...
Next load the data set, which is stored in the fivethirtyeight package
```{r}
data(hate_crimes)
```

Use the View function to take a look at the data in the viewer. And type ?hate_crimes into the console to see a description of the variables in this data set. 
...
What is the regression equation for your unemployment model??????
