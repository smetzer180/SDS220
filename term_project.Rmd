...
# 2. Proposal - Fri 10/19 5pm {#proposal}
...
I will have the exact submission format ready by Monday 9/24. However, your proposal will **definitely** involve making **exploratory data analysis (EDA)** plots like in ModernDive [Chapter 12.1.1](https://moderndive.netlify.com/12-thinking-with-data.html#seattle-house-prices){target="_blank"}.

<!--

Jenny suggests making explicit expectations. For example, they do not need to make this plot for 
proposal. 
...
You'll be making a figure like Figure 12.6 in ModernDive Chapter 12
...
# 3. Initial submission - Fri 11/9 5pm
...
1. Group leader: Once the initial submission is complete
    ...
    + Complete this [Google Form](https://docs.google.com/forms/d/e/1FAIpQLSf4Sc9GkO_QNp-FvB1_Fw_C-Va-kcW1FbvYT0hJT0HJIzal_A/viewform){target="_blank"}.
...
## 3.a) Overall feedback from initial submissions
...
# 4. Presentations - Mon 12/10 in-class
...
-->
1. Complete this Google Forms [survey](https://docs.google.com/forms/d/e/1FAIpQLSeEmiXTB6qIszAC5r3gLGmDuLQEYvrgRW-bRMezx6te7_7jpQ/viewform){target="_blank"}. 5% of your term project grade is based on completion of this survey. 
