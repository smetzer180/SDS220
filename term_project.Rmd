...
# 3. Initial submission - Fri 11/9 9pm
...
```{r, message=FALSE, warning=FALSE, eval=FALSE, fig.height=8/2}
library(ggplot2)
library(dplyr)
library(moderndive)
...
# Plot log10-transformed price
ggplot(house_prices, aes(x = log10_price)) +
  geom_histogram() +
  labs(x = "log10(House price)", title = "Seattle house prices") 
```
```{r, message=FALSE, warning=FALSE, eval=TRUE, echo=FALSE, fig.height=8/2}
